...
function Codelist_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Codelist_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Codelist_createClass(Constructor, protoProps, staticProps) { if (protoProps) Codelist_defineProperties(Constructor.prototype, protoProps); if (staticProps) Codelist_defineProperties(Constructor, staticProps); return Constructor; }
...
var CodeView = /*#__PURE__*/function () {
  function CodeView(context) {
    Codelist_classCallCheck(this, CodeView);
