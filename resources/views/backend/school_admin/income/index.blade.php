...
@section('content')
    ...
    <div class="mt-4">
        <div class="d-flex justify-content-between mb-4">
            ...
            @include('backend.school_admin.income.partials.action')
        </div>
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-12 col-12">
                            <div class="report-table-container">
                                <div class="table-responsive">
                                    <table id="income-table" class="table table-bordered table-striped dataTable dtr-inline"
        ...
        <div class="modal fade" id="createIncome" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="">
                        <form method="post" id="incomeForm" action="{{ route('admin.incomes.store') }}"
                            ...
                            <div class="col-md-12">
                                <div class="p-2 label-input">
                                    <label for="incomehead_id">Income Head</label>
                                    <div class="select">

                                        <select id="dynamic_incomehead_id" name="incomehead_id" data-iteration="0"
                                            class="incomehead_id" required>
                                            <option disabled selected value="{{ old('incomehead_id') }}">Select Income Head
                                            </option>
                                            @foreach ($incomeshead as $income)
                                ...
                                <div class="p-2 label-input">
                                    ...
                                    <div class="single-input-modal">
                                        <input type="text" value="{{ old('amount') }}" name="amount"
                                            class="input-text single-input-text" id="dynamic_amount" required>
                                    </div>
                                </div>
                                <div class="p-2 label-input">
...
<script>
        ...
        $(document).on('click', '.edit-income', function() {
            ...
            //     id);
            $('#incomeForm').attr('action', '{{ route('admin.incomes.update', '') }}' + '/' + id);
            $('#methodField').val('PUT');
