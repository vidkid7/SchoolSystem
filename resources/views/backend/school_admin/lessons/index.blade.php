                        ...
                        <div class="col-sm-12 col-md-12 col-12">
                            <div class="report-table-container">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="lesson-table" class="table table-bordered table-striped dataTable dtr-inline"
        ...
        <div class="modal fade" id="createLesson" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="">
                        <form method="post" id="lessonForm" action="{{ route('admin.lessons.store') }}">
                            @csrf
...
@section('scripts')
    <script>
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        data.forEach(function(value) {
                            var newLesson = `<div class="p-2 label-input">
            <label>Lesson Name<span class="must">*</span></label>
            <div class="single-input-modal">
        ...
        $(document).on('click', '.edit-lesson', function() {
            ...
            $('#lessonForm').attr('action', '{{ route('admin.lessons.update', '') }}' + '/' + id);
            $('#methodField').val('PUT');
