...
@section('content')
    ...
    <div class="mt-4">
        <div class="d-flex justify-content-between mb-4">
            ...
            @include('backend.shared.department.partials.action')
        </div>
        <div class="card">
            <div class="card-body">
        ...
        <div class="modal fade" id="createDepartment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="">
                        <form method="post" id="departmentForm" action="{{ route('admin.departments.store') }}">
                            @csrf
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.edit-department', function() {
            ...
            $('#departmentForm').attr('action', '{{ route('admin.departments.update', '') }}' + '/' + id);
            $('#methodField').val('PUT');
