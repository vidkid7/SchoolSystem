@can('edit_municipality_users')
    <a href="{{ route('admin.municipality-users.edit', $user->id) }}" class="btn btn-outline-primary btn-sm mx-1"
        data-toggle="tooltip" data-placement="top" title="Edit">
        <i class="fa fa-edit"></i>
    </a>
@endcan

@can('delete_municipality_users')
    ...
    <div class="modal fade" id="delete{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('admin.municipality-users.destroy', $user->id) }}"
